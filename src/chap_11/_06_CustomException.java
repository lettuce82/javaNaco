    ...
    public static void main(String[] args) {
        ...
        try {
            if (age < 19) {
                ...
                throw new AgeLessTan19Exception("만 19세 미만에게는 판매하지 않습니다.");
            } else {
                System.out.println("주문하신 상품 여기 있습니다.");
            }
        } catch (AgeLessTan19Exception e) {
...
class AgeLessTan19Exception extends Exception {
    public AgeLessTan19Exception(String message) {
        super(message);
    }
}